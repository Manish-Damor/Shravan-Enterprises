            ...
            <div className="mt-8 rounded-3xl border border-white/10 bg-gradient-to-br from-white/8 to-white/4 p-4">
              ...
              <div className="mt-3 space-y-2 text-xs text-slate-300">
                <div className="flex items-center gap-2">
                  ...
                  Brochure-ready product data
                </div>

                <div className="flex items-center gap-2">
                  <ClipboardList className="h-3.5 w-3.5 text-emerald-300" />
                  Dynamic specs and applications
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  Live product, enquiry, brochure, and content stats
                </div>
              </div>
            </div>
          </nav>
            ...
            <div className="flex items-center gap-3 px-4 py-4 sm:px-6 lg:px-8">
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="truncate text-sm text-slate-600">
                  Manage industrial products, brochures, content, and enquiries in one place.
                </div>
              </div>
