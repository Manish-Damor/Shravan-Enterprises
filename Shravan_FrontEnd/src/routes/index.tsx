...
const testimonials = [
  {
    name: "Rakesh Patel",
    company: "Granite Works, Rajasthan",
    text: "Shravan Enterprises has been a dependable partner for our material requirements. Product quality and service response are both consistently strong.",
  },
  {
    name: "Suresh Mehta",
    company: "Composite India Pvt Ltd",
    text: "Their industrial product range is practical, well-positioned, and supported by a team that understands actual application needs.",
  },
  {
    name: "Anil Sharma",
    company: "Marvel Marbles",
    text: "For vacuum process consumables and finishing materials, Shravan brings the reliability we need on active projects.",
  },
];
