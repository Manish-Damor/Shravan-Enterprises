...
// Migration script: normalize existing `products` documents into the new schema
// Usage: node tools/migrate-products-to-new-schema.mjs
...
(async function run() {
  ...
  while (await cursor.hasNext()) {
    ...
    // perform an idempotent update: set fields only if changed
